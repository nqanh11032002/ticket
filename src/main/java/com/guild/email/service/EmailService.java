package com.guild.email.service;

import com.guild.email.entity.Email;
import com.guild.email.service.interfaces.IEmailService;
...
public class EmailService implements IEmailService {
    ...
    public String sendSimpleMail(Email email) {
        ...
        try {
            ...
            for (var emailReceive : email.getRecipient()) {
                // Setting up necessary details
                mailMessage.setFrom(sender);
                mailMessage.setTo(emailReceive);
    ...
    public String sendMailWithAttachment(Email email) {
        ...
        try {
            ...
            for (var emailReceive : email.getRecipient()) {
                ...
                mimeMessageHelper.setTo(emailReceive);
